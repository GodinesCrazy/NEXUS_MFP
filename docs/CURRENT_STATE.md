...
## Estado de auditoría 2026-09-23
...
- la ejecución integral de `src/nexus_mfp.py --causal` no llega actualmente a v1.19: la carga embebida de v1.7 falla bajo Python 3.10 y v1.14 aborta porque no se genera `mfp3_output_v17/portfolio_daily.csv`;
